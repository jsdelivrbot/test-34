...
{
    public partial class removeJoinDateAndIsConfirmed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "IsConfirmed", table: "GolfMatchPlayer");
            migrationBuilder.DropColumn(name: "JoinDate", table: "GolfMatchPlayer");
